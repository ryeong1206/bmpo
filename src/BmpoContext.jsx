...
// 정보---------------------------------------------------------------
    ...
    const ConcertData = [
        {
            id: 1,
            poster: `${process.env.PUBLIC_URL}/images/01_info.png`,
            infoimg: `${process.env.PUBLIC_URL}/images/01_info.png`,
            ...
            reservdate: '25년 2월 1일 13:00 ~ 25년 3월 1일 24:00',
            reservdatef: {
                start: new Date(2025, 2-1, 1, 13, 0),
                end: new Date(2025, 3-1, 1, 23, 59)
            },
            age: 14,
            hours: 40,
        ...
        {
            id: 2,
            poster: `${process.env.PUBLIC_URL}/images/02_info.png`,
            infoimg: `${process.env.PUBLIC_URL}/images/02_info.png`,
            title: 'BMFO와 함께하는 추억의 영화음악',
            region: '부산',
            location: '문화 회관 중극장',
            performancedate: '25년 6월 3일 ~ 25년 7월 2일',
            performancedatef: {
                start: new Date(2025, 6-1, 3),
                end: new Date(2025, 7-1, 2)
            },
            reservdate: '25년 5월 1일 13:00 ~ 25년 6월 1일 24:00',
            reservdatef: {
                start: new Date(2025, 5-1, 1, 13, 0),
                end: new Date(2025, 6-1, 1, 23, 59)
            },
            age: 16,
            hours: 100,
            price: 'R석 90,000원 / S석 70,000원 / A석 30,000원',
        ...
        {
            id: 3,
            poster: `${process.env.PUBLIC_URL}/images/03_info.png`,
            infoimg: `${process.env.PUBLIC_URL}/images/03_info.png`,
            title: '가곡과 아리아의 밤',
            region: '대구',
            location: '예술회관 공연장',
            performancedate: '25년 8월 3일 ~ 25년 10월 2일',
            performancedatef: {
                start: new Date(2025, 8-1, 3),
        ...
        {
            id: 4,
            poster: `${process.env.PUBLIC_URL}/images/04_poster.png`,
            infoimg: `${process.env.PUBLIC_URL}/images/04_info.png`,
        ...
        {
            id: 5,
            poster: `${process.env.PUBLIC_URL}/images/05_poster.png`,
            infoimg: `${process.env.PUBLIC_URL}/images/05_info.png`,
            title: '부산 메트로폴리탄 필하모닉 오케스트라 10주년 기념 감사공연',
            region: '부산',
            location: '롯데콘서트홀',
        ...
        {
            id: 6,
            poster: `${process.env.PUBLIC_URL}/images/06_poster.png`,
            infoimg: `${process.env.PUBLIC_URL}/images/06_info.png`,
            title: 'BMFO와 함께하는 추억의 영화음악',
            region: '부산',
            location: '롯데콘서트홀',
            performancedate: '25년 4월 3일 ~ 25년 5월 2일',
    ...
    const GalleryData = [
        {
            ...
            date: '25년 4월 10일',
            text: '',
            file: `${process.env.PUBLIC_URL}/images/gallery_01_file_01.svg`,
            img1: `${process.env.PUBLIC_URL}/images/gallery_01_img_01.png`,
            img2: `${process.env.PUBLIC_URL}/images/gallery_01_img_02.png`,
            img3: '',
            img4: '',
            video1: '',
            video2: '',
        },
        {
            ...
            date: '25년 4월 10일',
            text: '',
            file: `${process.env.PUBLIC_URL}/images/gallery_02_file_01.svg`,
            img1: `${process.env.PUBLIC_URL}/images/gallery_02_img_01.png`,
            img2: `${process.env.PUBLIC_URL}/images/gallery_02_img_02.png`,
            img3: '',
            img4: '',
            video1: '',
            video2: '',
        },
        {
            ...
            date: '25년 4월 10일',
            text: '',
            file: `${process.env.PUBLIC_URL}/images/gallery_03_file_01.svg`,
            img1: `${process.env.PUBLIC_URL}/images/gallery_03_img_01.png`,
            img2: `${process.env.PUBLIC_URL}/images/gallery_03_img_02.png`,
            img3: '',
            img4: '',
            video1: '',
            video2: '',
    ...
    const ProjectData = [
        {
            ...
            date: '25년 4월 10일',
            text: '',
            file: `${process.env.PUBLIC_URL}/images/project_01_file_01.svg`,
            img1: `${process.env.PUBLIC_URL}/images/project_01_img_01.png`,
            img2: `${process.env.PUBLIC_URL}/images/project_01_img_02.png`,
            img3: '',
            img4: '',
            video1: '',
            video2: '',
        },
        {
            ...
            date: '25년 4월 10일',
            text: '',
            file: `${process.env.PUBLIC_URL}/images/project_02_file_01.svg`,
            img1: `${process.env.PUBLIC_URL}/images/project_02_img_01.png`,
            img2: `${process.env.PUBLIC_URL}/images/project_02_img_02.png`,
            img3: '',
            img4: '',
            video1: '',
            video2: '',
        },
        {
            ...
            date: '25년 4월 10일',
            text: '',
            file: `${process.env.PUBLIC_URL}/images/project_03_file_01.svg`,
            img1: `${process.env.PUBLIC_URL}/images/project_03_img_01.png`,
            img2: `${process.env.PUBLIC_URL}/images/project_03_img_02.png`,
            img3: '',
            img4: '',
            video1: '',
            video2: '',
